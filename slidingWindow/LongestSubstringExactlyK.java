...
// // Add the entering element (nums[i]) and subtract the leaving element
// (nums[i -
// // windowSize])
...
// // Edge cases: if the string is empty, shorter than k, or we want 0
// characters
...
// // getOrDefault says: "If we haven't seen this letter before, assume its
// count
// // was 0, then add 1."
// charFrequency.put(rightChar, charFrequency.getOrDefault(rightChar, 0) + 1);

// // 3. RULE CHECK: The map's .size() tells us exactly how many unique letters
// we
// // have!
    ...
    public int maxFrequency(int[] nums, int k) {
        ...
        for (int right = 0; right < nums.length; right++) {
            ...
            while (cost > k) {
                ...
                left++;
                // Recalculate window size and cost for the while loop condition
